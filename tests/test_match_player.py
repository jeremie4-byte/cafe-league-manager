...
class TestMatchPlayer (unittest.TestCase):
    ...
    def test_valid_0player_id(self):
        match_player2 = MatchPlayer(0, 2, MatchResult.SECOND_PLACE, Attendance.NO_SHOW)
        self.assertEqual(match_player2.player_id, 0)

    """Test to see that valid player_id are accepted"""
    def test_valid_player_id(self):
        match_player3 = MatchPlayer(2, 3, MatchResult.THIRD_PLACE, Attendance.CANCELLED)
    ...
    def test_invalid_player_id(self):
        with self.assertRaises(ValueError):
            match_player4 = MatchPlayer(-500, 4, MatchResult.FOURTH_PLACE, Attendance.NO_SHOW)
    ...
    def test_first_place(self):
        match_player8 = MatchPlayer(6, 6, MatchResult.FIRST_PLACE, Attendance.NO_SHOW)
    ...
    def test_third_place(self):
        match_player10 = MatchPlayer(8, 8, MatchResult.THIRD_PLACE, Attendance.NO_SHOW)
    ...
    def test_seventh_place(self):
        match_player14 = MatchPlayer(12, 12, MatchResult.SEVENTH_PLACE, Attendance.CANCELLED)
    ...
    """Test that an invalid match result raises a ValueError"""
    ...
    def test_match_cancelled(self):
        match_player18 = MatchPlayer(16, 16, MatchResult.EIGHT_PLACE, Attendance.CANCELLED)
    ...
    def test_match_no_show(self):
        match_player19 = MatchPlayer(17, 17, MatchResult.FOURTH_PLACE, Attendance.NO_SHOW)
        self.assertEqual(match_player19.attendance, Attendance.NO_SHOW)

    """Test that an invalid attendance entry raises a ValueError"""
